...
def create_mates_embed1(mates, bluewin, blueObj):
    ...
    embed1.add_field(name=mates[0][0],
                    value=mates[0][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[0][0],
                    inline=False)
    embed1.add_field(name=mates[1][0],
                    value=mates[1][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[1][0],
                    inline=False)
    embed1.add_field(name=mates[2][0],
                    value=mates[2][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[2][0],
                    inline=False)
    embed1.add_field(name=mates[3][0],
                    value=mates[3][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[3][0],
                    inline=False)
    embed1.add_field(name=mates[4][0],
                    value=mates[4][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[4][0],
                    inline=False)
...
def create_mates_embed2(mates, redwin, redObj):
    ...
    embed2.add_field(name=mates[5][0],
                    value=mates[5][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[5][0],
                    inline=False)
    embed2.add_field(name=mates[6][0],
                    value=mates[6][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[6][0],
                    inline=False)
    embed2.add_field(name=mates[7][0],
                    value=mates[7][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[7][0],
                    inline=False)
    embed2.add_field(name=mates[8][0],
                    value=mates[8][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[8][0],
                    inline=False)
    embed2.add_field(name=mates[9][0],
                    value=mates[9][1],
                    url="https://euw.op.gg/summoners/euw/"+mates[9][0],
                    inline=False)
